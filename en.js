const EN = {
    ...
    "titulo_contacto_owner": "Quick Contact",
    "owner_name_igor": "Igor",
    "owner_name_leti": "Leti",
    "owner_tel_igor": "-34 655 709 191",
    "owner_tel_leti": "-34 655 709 192",

    // --- NUEVAS CLAVES DE UBICACIÓN DEL APARTAMENTO (WELCOME) ---
    "titulo_piso": "Your Apartment",
    "addr_piso_name": "Atalaia Terrace",
    "addr_piso_desc": "Segundo Izpizua, 7 - 7D\n20001 Donostia", // For display
    ...
    "pintxos_list": [
        {
            ...
            "recommendation": "'Txopito', 'Txalupa', 'Udaberri'."
        },
        {
            "neib": "Gros",
            ...
            "recommendation": "Tuna tataki, Idiazabal risotto."
        },
        {
            "neib": "Gros",
            ...
            "recommendation": "'Mini completo', 'Indurain', Pork snout."
        },
        {
            "neib": "Gros",
            "name": "Casa Senra",
        ...
        },
        {
            ...
            "recommendation": "Grilled wild mushrooms, Spider crab tartlet."
        },
        {
            "neib": "Old Town",
            "name": "Baztan",
            ...
            "recommendation": "Tortilla pintxo, Stuffed pepper."
        },
        {
            "neib": "Old Town",
            "name": "Casa Urola",
    ...
    "basque_restaurants": [
        { 
            ...
            "tel": "+34 943 32 33 10",
            "price": "€€€",
            "map": "Ategorrietako Galtzada Zaharra, 3, 20013 Donostia / San Sebastián, Gipuzkoa"
        },
        { 
            "neib": "Gros",
            "name": "Zelai Txiki", 
            ...
            "tel": "+34 688 61 15 81",
            "price": "€€",
            "map": "Rodil kalea, 79, 20013 Donostia / San Sebastián, Gipuzkoa"
        },
        { 
            "neib": "Old Town",
    ...
    // MICHELIN RESTAURANTS SCREEN
    "michelin_titulo": "Michelin Star Restaurants",
    ...
    "txuleta_titulo": "Txuleta Restaurants",
    "txuleta_restaurants": [
        {
            "neib": "Gros",
    ...
    // CIDER HOUSE RESTAURANTS SCREEN
    ...
    "act_1_desc": "La Concha Beach is the heart of San Sebastián. Enjoy a relaxing walk along its iconic railing, sunbathe on its fine sand, or take a dip in its calm waters. It is the perfect place to enjoy the views of the bay with Santa Clara Island in the center.",
    "act_1_img": "images/concha.jpg",
    "act_2_titulo": "Pintxos Route in the Old Town",
    "act_2_desc": "The Old Town of San Sebastián is world-famous for its pintxos bars. Get lost in its streets and discover the incredible variety of miniature culinary delights. Each bar has its specialty, so don't hesitate to try several!",
